from texts import admin_menu_texts

# Тексты сообщений
NO_EVENT_ERROR_TEXT = "За тобой не закреплено мероприятие"

SCAN_CODE_TEMPLATE = "Текущее мероприятие: {}. \n" \
                     "Введи код участника или нажми \"" + admin_menu_texts.BACK_TO_MENU_BUTTON_TEXT + \
                     "\", чтобы вернуться в меню"
SCAN_CODE_TEXT = "Введи код участника или нажми \"" + admin_menu_texts.BACK_TO_MENU_BUTTON_TEXT + \
                 "\", чтобы вернуться в меню"
