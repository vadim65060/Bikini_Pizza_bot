...
"Коины" - это наши бонусные баллы. За каждый ваш заказ мы возвращаем вам {int(constants.CASHBACK_PERCENT * 100)}% его стоимости обратно в виде этих самых коинов. Круто, правда? 😎

Как начать зарабатывать "Коины"?
Используйте код "bikini200", в главном меню есть кнопка 😉
А ещё баллы будут капать за каждую вашу покупку. Чем больше заказов, тем больше коинов! 💪

Как потратить накопленное?
Можно оплатить до {int(constants.BALLS_USING_LIMIT_PERCENT * 100)}% от вашей покупки коинами! Когда будете оформлять заказ, просто выберите опцию "Использовать баллы", укажите сколько хотите потратить, и вуаля! 🎉

А на доставку и акции распространяется?
Здесь важно: коины не работают с акциями и при доставке. Но в наших пунктах выдачи - пожалуйста!
