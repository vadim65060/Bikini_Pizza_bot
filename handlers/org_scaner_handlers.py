...
#         await message.answer(org_scaner_texts.MONEY_GIVEN_ALREADY_TEMPLATE.format('name'),
#                              parse_mode=ParseMode.HTML)
#         await message.answer(org_scaner_texts.SCAN_CODE_TEXT,
#                              parse_mode=ParseMode.HTML)
#         return
...
#
#     await message.answer(org_scaner_texts.GIVE_MONEY_TEMPLATE.format('name', money_value),
